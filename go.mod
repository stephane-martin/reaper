module github.com/stephane-martin/reaper
...
require (
	...
	github.com/bmizerany/perks v0.0.0-20140429223840-6cb9d9d72930 // indirect
	...
	github.com/nsqio/go-diskqueue v0.0.0-20170827071139-0681a1afee12 // indirect
